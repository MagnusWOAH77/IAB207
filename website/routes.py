from flask import Blueprint, Flask, abort, redirect, render_template, url_for, request, flash
...
def create_event_page():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for("main.event_details_page", event_id=event.id))
    else:
        print(form.errors)
...
def cancel_event(event_id):
    ...
    return redirect(url_for("main.my_events_page"))
...
@main_bp.route("/event/<int:event_id>/cancel-booking", methods=["POST"])
@login_required
